...
export default function RegistrationForm() {
  ...
  try {
    // Send ALL form data including confirm_password
    await registerWholesaler(formData).unwrap();
  } catch (err) {
  ...
  // Add confirm_password field to Personal Info step
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.first_name ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.last_name ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
            placeholder="Enter last name"
          />
          {errors.last_name && <p className="text-error-500 text-sm mt-1">{errors.last_name}</p>}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            maxLength="10"
          />
          {errors.mobile && <p className="text-error-500 text-sm mt-1">{errors.mobile}</p>}
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.confirm_password ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
            placeholder="Confirm password"
          />
          {errors.confirm_password && <p className="text-error-500 text-sm mt-1">{errors.confirm_password}</p>}
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
            errors.business_name ? 'border-error-500' : 'border-medium focus:border-focus'
          }`}
          placeholder="Enter business name"
        />
        {errors.business_name && <p className="text-error-500 text-sm mt-1">{errors.business_name}</p>}
      </div>
      ...
      <div>
        ...
        <select
          ...
          onChange={handleInputChange}
          className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
            errors.business_type ? 'border-error-500' : 'border-medium focus:border-focus'
          }`}
        >
        ...
        {errors.business_type && <p className="text-error-500 text-sm mt-1">{errors.business_type}</p>}
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
            errors.shop_address ? 'border-error-500' : 'border-medium focus:border-focus'
          }`}
          placeholder="Enter full address"
        />
        {errors.shop_address && <p className="text-error-500 text-sm mt-1">{errors.shop_address}</p>}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            maxLength="6"
          />
          {errors.pincode && <p className="text-error-500 text-sm mt-1">{errors.pincode}</p>}
        </div>
  ...
  const renderProductInfo = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        {errors.categories && <p className="text-error-500 text-sm mt-2">{errors.categories}</p>}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.price_range ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
          >
          ...
          {errors.price_range && <p className="text-error-500 text-sm mt-1">{errors.price_range}</p>}
        </div>
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
            errors.account_holder ? 'border-error-500' : 'border-medium focus:border-focus'
          }`}
          placeholder="Enter account holder name"
        />
        {errors.account_holder && <p className="text-error-500 text-sm mt-1">{errors.account_holder}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
            errors.bank_name ? 'border-error-500' : 'border-medium focus:border-focus'
          }`}
          placeholder="Enter bank name"
        />
        {errors.bank_name && <p className="text-error-500 text-sm mt-1">{errors.bank_name}</p>}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.account_number ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
            placeholder="Enter account number"
          />
          {errors.account_number && <p className="text-error-500 text-sm mt-1">{errors.account_number}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 border-2 rounded-radius-lg focus:outline-none bg-surface-1 text-text-primary ${
              errors.ifsc_code ? 'border-error-500' : 'border-medium focus:border-focus'
            }`}
            placeholder="Enter IFSC code"
          />
          {errors.ifsc_code && <p className="text-error-500 text-sm mt-1">{errors.ifsc_code}</p>}
        </div>
      </div>
