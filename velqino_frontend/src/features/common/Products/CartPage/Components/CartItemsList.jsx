...
import { Trash2, Heart, Clock, Minus, Plus, Loader2 } from '../../../../../utils/icons';
      ...
      <div key={item.id} className="p-4 sm:p-5 hover:bg-gray-50 transition-colors">
        <div className="flex flex-col md:grid md:grid-cols-12 gap-4 sm:gap-5">
          ...
          <div className="flex gap-4 col-span-6">
            <Link href={`/product/${item.product_detail?.slug || item.id}`} className="flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 bg-gray-100 rounded-lg overflow-hidden">
              <img 
