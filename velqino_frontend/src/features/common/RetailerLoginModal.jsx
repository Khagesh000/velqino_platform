...
export default function RetailerLoginModal({ isOpen, onClose, onLogin }) {
  ...
  <div className="flex min-h-full items-center justify-center p-4">
    <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl animate-slideUp">
      ...
      <button
        onClick={onClose}
        className="absolute right-4 top-4 p-1 text-gray-400 hover:text-primary-600 rounded-lg transition-all z-10"
      >
        <X size={20} />
      </button>
      ...
      <div className="text-center pt-8 pb-4 px-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Access your retailer dashboard</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-4">
        ...
        <div className="p-3 bg-primary-50 rounded-lg">
          <div className="flex items-start gap-2">
            <Store size={14} className="text-primary-600 mt-0.5" />
            <p className="text-xs text-primary-700">
              Retailer accounts are for businesses purchasing products in bulk for resale.
