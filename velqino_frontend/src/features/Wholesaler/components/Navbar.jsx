...
const handleVendorClick = () => {
  ...
  const isRegistered = localStorage.getItem('is_wholesaler_registered');

  if (!isRegistered) {
    handleNavigation('/wholesaler/wholesalerregistrationform');
  } else if (token || refresh) {
    handleNavigation('/wholesaler/wholesalerdashboard');
  } else {
    setIsLoginOpen(true);
  }
};
