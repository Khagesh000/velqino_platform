...
export default function ImportImagesModal({ onClose }) {
  ...
  const [mode, setMode] = useState(null) // 'front_only' or 'front_back'
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
                ...
                <span className="text-sm text-primary-700 font-medium">
                    {mode === 'front_only' ? '📸 Front Only' : '📸 Front + Back pairs'}
                </span>
                <button
                ...
                <p className="text-gray-600">
                    {mode === 'front_only'
                    ? 'Select front images (1 per product)'
                    : 'Select images in pairs (front1, back1, front2, back2...)'}
                </p>
            ...
            {showForm && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-green-600">
                  🖼️ {images.length} images selected ({images.length / 2} products)
                </p>
                ...
                >
                  {uploading ? 'Processing... ⏳' : `Upload ${images.length / 2} Products`}
                </button>
